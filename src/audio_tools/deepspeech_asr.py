...
def infer(model="./deepspeech-0.9.0-models.pbmm", scorer="./deepspeech-0.9.3-models.scorer", audio="./bad_guy.wav"):
    ...
    # ds.setBeamWidth(args.beam_width) # 'Beam width for the CTC decoder'
    ...
    # hot_words = "资本:0.5,奴隶:0.5,美好:0.9"
    ...
    # infer_text = ds.sttWithMetadata(audio, 1).transcripts
    # print(metadata_json_output(ds.sttWithMetadata(audio, args.candidate_transcripts)))
    infer_text = ds.stt(audio)

    print("Text: {}".format(infer_text))
...
if __name__ == '__main__':
    # infer(audio="./human_hammer.wav")
    infer(model="./deepspeech-0.9.3-models.pbmm", audio="./Try something new for 30 days - Matt Cutts-UNP03fDSj1U_segment.wav")
